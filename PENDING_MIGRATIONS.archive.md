# PENDING MIGRATIONS ARCHIVE

Entries moved out of `PENDING_MIGRATIONS.md` once their migration had been
applied to prod for about 30 days. The same idea as `prd.archive.json`: the
live file stays short enough to read, and nothing is deleted.

Nothing reads this file to decide what is held. The held list is
`supabase/held-migrations.json`, and `PENDING_MIGRATIONS.md` explains it.
Entries are copied verbatim, in the order they had in the live file, so a
sentence here that says "HELD", "below" or "above" describes that file on the
day it was written, not today.

Archived 2026-09-23 with a cutoff of 2026-08-24: every APPLIED or RESOLVED
section whose newest date is before the cutoff.
...
## WHAT IS STILL WAITING FOR YOU, 2026-09-11 (superseded 2026-09-23 by the rewritten section in PENDING_MIGRATIONS.md)
...
## How this file works, before 2026-09-23 (superseded by the registry-based section in PENDING_MIGRATIONS.md)
