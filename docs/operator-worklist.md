...
Regenerate with: node scripts/operator-worklist.mjs. Built from prd.json, where 176 of 325 open stories carry at least one OPERATOR criterion — a step only you can take.
