...
Regenerate with: node scripts/operator-worklist.mjs. Built from prd.json, where 157 of 278 open stories carry at least one OPERATOR criterion — a step only you can take.
