...
| `GRADING_SCALE_REFERENCE` | ⬜ Coolify edge | Default **OFF**. On, adds a scale reference to the grading prompt; off is byte-identical. A prompt-surface change, so it rides the shadow/eval/canary lane like any other. |
