---
title: iOS parity audit
type: reference
status: archived
source_of_truth: vault
code_refs: []
reviewed: 2026-07-19
tags: [audit, ios, snapshot]
summary: Web/iOS feature parity check; 4 of 6 items closed, the remaining two extracted to US-2090.
---

> [!info] Archived 2026-07-19 — two items extracted first
> **As-of date: 2026-07-18.** Four of six items were complete. The two that were
> not had **no covering story anywhere** in prd.json or prd.archive.json, so they
> were filed as **US-2090** before this was archived:
>
> - Auth'd seam-flow UITests (only launch smoke exists today)
> - Inline per-field editing of saved comps on iOS (currently delete + re-add)
