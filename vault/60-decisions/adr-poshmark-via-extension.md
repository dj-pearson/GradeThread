---
title: "ADR: reach Poshmark by extension, not by Rithum"
type: decision
status: accepted
source_of_truth: vault
code_refs: []
reviewed: 2026-07-19
tags: [decision, marketplaces, poshmark, bizdev]
summary: Why Poshmark/Mercari/Grailed are reached through the browser extension rather than an aggregator contract.
---

> [!info] Story references
> This note predates the vault and used `[[US-716]]`-style wikilinks that pointed
> at nothing — there are no per-story notes, by design (see
> [[adr-0001-knowledge-vault]]). US-2056 converted them to plain ids and resolved
> what they mean:
>
> - **US-716** — "GradeThread Lister" browser-extension companion for the no-API
>   marketplaces (Poshmark / Mercari / Grailed). Completed.
> - **US-718** — Make the Marketplaces UI and plan copy match real capability
>   tiers; owns `MARKETPLACE_TIER`. Completed.
>
> Full text is in `prd.archive.json`.
...
- [[cross-listing]] — the channel-reach model this decision sets
- [[pricing]] — the marketplace cap this feeds (extension channels consume none)
- [[adr-depop-partner-application]] — the opposite call, for a marketplace with an API
- [[INDEX]]
