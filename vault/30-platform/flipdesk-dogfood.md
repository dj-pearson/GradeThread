---
title: FlipDesk dogfooding notes
type: reference
status: current
source_of_truth: vault
code_refs: []
reviewed: 2026-07-19
tags: [flipdesk, product, dogfood]
summary: What broke when the pipeline was run end to end on real inventory.
---
...
- [[flipdesk-reseller-gaps]] — the gap list this evidence feeds
- [[ebay-aspect-value-limit]] — one of the concrete publish failures hit
- [[INDEX]]
