...
> `readCachedDefaults`. Its title says "policies", but what it describes is the condition enum and the POLICY IDS sent at publish, not how a default is chosen at sync time.
>
