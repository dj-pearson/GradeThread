---
title: Subscription unit economics
type: reference
status: current
source_of_truth: vault
code_refs: []
reviewed: 2026-07-19
tags: [pricing, economics, margin]
summary: Cost per tier at realistic and worst-case utilization, and why the AI-action caps sit where they do.
---
# FlipDesk Subscription — Hard Limits, Enforcement & Unit Economics

Subscription-tier companion to `vault/50-business/ai-profitability.md` (which is
