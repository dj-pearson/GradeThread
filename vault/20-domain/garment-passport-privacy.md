---
title: Garment passport privacy
type: contract
status: current
source_of_truth: code
code_refs:
  - services/edge-functions/src/lib/garment-passport.ts
reviewed: 2026-07-18
tags: [privacy, passport, contract]
summary: What a passport may expose publicly, and the salted-hash rule that keeps it de-identified.
---
...
- [[data-retention]] — erasure obligations that reach passport records
- [[grading-scale-and-weights]] — the grade a passport surfaces publicly
- [[INDEX]]
