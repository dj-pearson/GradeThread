...
- [[shipped-but-unwired]] — learning — Modules that pass their tests while nothing calls them; one is a real unenforced guarantee, one is uncalled by design, one was a policy retirement that got deleted once a live switch started promising it — and telling the shapes apart is the point.
