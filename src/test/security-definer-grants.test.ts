...
const BODY_GUARDED = [
  ...
  "seller_scorecard",
  // 00836. community_benchmarks for one workspace: v1's cohort, the you block
  // for p_owner_id. Same guard helper, plus a membership check on the owner.
  "community_benchmarks_v2",
