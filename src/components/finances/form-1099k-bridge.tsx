      ...
      <CardHeader className="flex-row flex-wrap items-start justify-between gap-3 space-y-0">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            <SelectTrigger
              className="h-9 w-28"
              aria-label="Tax year for the 1099-K reconciliation"
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              ...
              <>
                {!bridge.form_present && (
                  <p className="text-[13px] leading-relaxed text-muted-foreground">
                    You have not entered a 1099-K for{" "}
                    {platformLabel(bridge.platform)} yet. This shows what your
                    own records add up to, which is what the form should say.
                  </p>
                )}
                ...
                {!bridgeAddsUp(rows) && (
                  <p className="text-[13px] leading-relaxed text-brand-red-text">
                    These lines do not add up to the total, which is a bug on
                    our side. Don't use this figure. Please tell us.
                  </p>
                )}
...
function FormDialog({
  ...
  if (open && seededFor !== key) {
    ...
    setCount(
      existing?.transaction_count ? String(existing.transaction_count) : "",
    );
  }
      ...
      <DialogContent>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            />
            <p className="text-[13px] leading-relaxed text-muted-foreground">
              Worth entering. If this disagrees with our sale count, it tells
              you straight away whether the difference is missing sales or wrong
              amounts.
            </p>
          </div>
          <div className="space-y-1">
