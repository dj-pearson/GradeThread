...
- **Deploy/launch:** `DEPLOY.md` (order DB→edge→frontend + rollback) · `LAUNCH_CHECKLIST.md` (env gate, Coolify scheduled tasks, backup drill, smoke). Also `BACKUPS.md`, `ROLLBACK.md`, `vault/10-ops/incident-response.md`, `SECURITY.md`, `MIGRATIONS.md`, `SCALING.md`, `vault/10-ops/key-rotation.md` in repo root.
