...
| Inventory grade triage | ✅ Sort inventory by "Highest grade" and a "Graded only" filter toggle in the list's sort/filter menu, so resellers can triage by condition. |
