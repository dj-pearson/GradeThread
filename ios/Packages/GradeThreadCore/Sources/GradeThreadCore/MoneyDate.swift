...
/// MOVED HERE FROM THE APP (mobile plan action 6) so the zone rules below run
/// under `swift test` on Linux instead of only on a macOS runner. The one
/// SwiftUI piece, the `dayPicker` Binding adapter, stays in the app as an
/// extension in `ios/GradeThread/Money/MoneyDate.swift`.
///
...
public enum MoneyDate {
    ...
    public static let wireFormatter: DateFormatter = {
        let f = DateFormatter()
    ...
    /// year.
    public static func today(now: Date = Date(), localCalendar: Calendar = .current) -> Date {
    ...
    public static func anchor(localDayOf date: Date, localCalendar: Calendar = .current) -> Date {
    ...
    public static func localMidnight(of stored: Date, localCalendar: Calendar = .current) -> Date {
    ...
    public static func monthAnchor(localMonthOf date: Date, localCalendar: Calendar = .current) -> Date {
    ...
    public static func startOfMonth(_ anchored: Date) -> Date {
    ...
    public static func addingMonths(_ months: Int, to anchoredMonthStart: Date) -> Date {
    ...
    public static func monthKey(_ anchoredMonthStart: Date) -> String {
    ...
    public static func monthLabel(_ anchoredMonthStart: Date) -> String {
    ...
    public static func dayDisplay(_ anchored: Date) -> String {
