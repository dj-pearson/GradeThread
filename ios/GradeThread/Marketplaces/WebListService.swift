...
@MainActor
public final class WebListService {

    public static let shared = WebListService()
    ...
    public func fill(itemId: String, platform: String, price: String?) async throws -> WebListFill {
        let body = FillBody(
    ...
    public func recordListed(itemId: String, platform: String, url: URL) async throws {
