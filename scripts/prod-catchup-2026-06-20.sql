...
--   [schema-version] DB is STALE: applied=00256, this build expects 00282.
--   Refusing to start.  → site down until prod reaches the expected version.
--
-- This bundles migrations 00257 → 00282 VERBATIM (DDL + each file's
...
--
-- After running, the tail SELECT must report 00282; the next edge boot then
-- logs "[schema-version] OK — DB at 00282 matches expected 00282".
