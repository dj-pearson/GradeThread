...
begin
  ...
  where n.nspname = 'public'
    and p.proname in ('grant_grade_credits', 'debit_grade_credits', 'grant_api_credits', 'debit_api_credits', 'grant_appstore_credits', 'grant_buyer_reward_credit', 'issue_buyer_reward_credit', 'redeem_buyer_reward_credit', 'refund_buyer_reward_credit')
