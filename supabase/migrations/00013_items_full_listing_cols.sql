-- Append listing id + engagement counters to items_full so the Active
-- listings tab can edit the listing row directly and show views/watchers.
-- New columns are appended at the end (CREATE OR REPLACE VIEW constraint).
