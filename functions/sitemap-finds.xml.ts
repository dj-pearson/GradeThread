// Showcase "Finds" sub-sitemap (US-1855). Linked from the /sitemap.xml index
...
import { findsUrls, sitemapResponse } from "./_shared/sitemap";
...
async function buildSitemap(env: PagesEnv): Promise<Response> {
  ...
  return sitemapResponse("sitemap-finds.xml", () => findsUrls(env));
}
